        ...
        <div class="bg-white rounded-lg shadow">
          <div class="p-6">
            ...
            <table class="w-full table-auto">
              <tbody>
                <tr>
                  <td class="w-1/4 py-2">NO. INVOICE</td>
                  <td class="w-2 py-2">:</td>
                  <td class="py-2">
                    {{ detailOrder.invoice }}
                  </td>
                </tr>
                <tr>
                  <td class="w-1/4 py-2">NAMA LENGKAP</td>
                  <td class="w-2 py-2">:</td>
                  <td class="py-2">
                    {{ detailOrder.name }}
                  </td>
                ...
                <tr>
                  <td class="w-1/4 py-2">NO. TELP / WA</td>
                  <td class="w-2 py-2">:</td>
                  <td class="py-2">
                    {{ detailOrder.phone }}
                  </td>
                ...
                <tr>
                  <td class="w-1/4 py-2">KURIR / SERVICE / COST</td>
                  <td class="w-2 py-2">:</td>
                  <td class="py-2">
                ...
                <tr>
                  <td class="w-1/4 py-2">ALAMAT LENGKAP</td>
                  <td class="w-2 py-2">:</td>
                  <td class="py-2">
                    {{ detailOrder.address }}
                  </td>
                ...
                <tr>
                  <td class="w-1/4 py-2">TOTAL PEMBELIAN</td>
                  <td class="w-2 py-2">:</td>
                  <td class="py-2">
                ...
                <tr>
                  <td class="w-1/4 py-2">STATUS</td>
                  <td class="w-1 py-2">:</td>
                  <td class="py-2">
                    <button
                      v-if="detailOrder.status == 'Pending'" @click.prevent="payment(detailOrder.snap_token)"
                      class="bg-gray-500 hover:bg-gray-600 font-semibold py-2 px-4 rounded-full"
                    >
                      BAYAR SEKARANG
                    </button>
                    <button
        ...
        <div class="bg-white rounded-lg shadow mt-4">
          <div class="p-6">
            ...
            <table class="w-full">
              <tbody>
                <tr
                  v-for="product in detailOrder.orders"
                  :key="product.id"
